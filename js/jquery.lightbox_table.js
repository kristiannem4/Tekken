(function($, document, window, undefined){
    ...
    var lightbox = {
        ...
        createOverlay: function(){
            ...
            this.overlay = $('<div/>', {id: 'overlay_table'}).hide();
            this.image = $('<img/>', {src: '', alt: ''}).appendTo( this.overlay );
            $('.table_champions').appendTo( this.overlay );
        ...
        setImage: function(url){ this.image.attr('src',url); },

    };

    $.fn.lightbox_table = function(options)
    {
